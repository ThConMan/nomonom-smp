...
**MobFarmManager** is a paid plugin. Its config files are the vendor's product, not mine to
hand out, so they are not in this repo.

## What it did on Nomonom

Mob farm limits. Performance protection - stopped a handful of mega-farms from tanking TPS for everyone.
