...
**PhoenixCrates** is a paid plugin. Its config files are the vendor's product, not mine to
hand out, so they are not in this repo.

## What it did on Nomonom

Crate and reward system. Wired into voting and the store, so it was the payoff end of most player incentives.
